...
<html>
    ...
    <body>
     <h3 align="center">${sessionScope.status}</h3>
        <div class="container col-xs-12 col-md-4 col-md-offset-4 text-center">
            <h3>Election Home</h3>
           <a href="viewProfile" class="btn btn-primary col-xs-12">View Profile</a>
            
            <div class="col-xs-12">&nbsp;</div>
            <a href="addLocation" class="btn btn-primary col-xs-12">Add Location</a>
            <div class="col-xs-12">&nbsp;</div>
            <a href="removeLocation" class="btn btn-primary col-xs-12">Remove Location</a>
            <div class="col-xs-12">&nbsp;</div>
            ...
            <div class="col-xs-12">&nbsp;</div>
            <a href="authenticate.html" class="btn btn-primary col-xs-12">Authenticate</a>
            <div class="col-xs-12">&nbsp;</div>
            <a href="revoke.html" class="btn btn-primary col-xs-12">Revoke</a>
            <div class="col-xs-12">&nbsp;</div>
              <a href="sendEmail" class="btn btn-primary col-xs-12">SendEmail</a>
              <div class="col-xs-12">&nbsp;</div>
        </div>
    </body>
</html>
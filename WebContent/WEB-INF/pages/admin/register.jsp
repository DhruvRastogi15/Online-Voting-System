        ...
        <div class="container text-center form-group">
            <div id="user1">
                ...
                <form method="post" action="party" class="form modal-content  col-sm-offset-4 col-sm-4 col-xs-12">
                    ...
                    <input type="password" min="3" max="8" id="password" name="password" placeholder="Password" class="name form-control col-xs-12">  
                    
                    <input list="electionId" name="electionId" class="election form-control col-xs-12" placeholder="Election Id">

					<datalist id="electionId">
					<c:forEach var="c" items="${sessionScope.elecList}">
					 	<option>${c.id}</option>
					 	</c:forEach>
					</datalist>
            ...
            <div id="user2"> 
                ...
                <form method="post" action="candidate"  class="form modal-content  col-sm-offset-4 col-sm-4 col-xs-12">
                    <label class="control-label col-xs-2" for="company">Role:</label>
                    <div class="col-xs-9 col-xs-offset-1">
                        <select id="roleCandidate" name="role" class="form-control selop" onchange="showCandidate(this)">
					...
					<input list="location" name="locationId" class="location form-control col-xs-12" placeholder="Location">
					<datalist id="location">
					 <c:forEach var="c" items="${sessionScope.locList}">
					 	<option> ${c.locationId}</option>
					 	</c:forEach>
					</datalist>
                    
                    <input list="electionId1"  name="electionId" placeholder="Election ID" class="electionId form-control col-xs-12">
                    <datalist id="electionId1">
					 <c:forEach var="c" items="${sessionScope.elecList}">
					 	<option> ${c.id}</option>
					 	</c:forEach>
					</datalist>  
					...
					<input list="partyId"  name="partyId" placeholder="Party ID" class="partyId form-control col-xs-12">
                    <datalist id="partyId">
					 <c:forEach var="c" items="${sessionScope.partyList}">
					 	<option> ${c.eId}</option>
					 	</c:forEach>
					</datalist> 
            ...
            <div id="user3">
                ...
                <form method="post" action="voter" class="form modal-content  col-sm-offset-4 col-sm-4 col-xs-12">
                    <label class="control-label col-xs-2" for="company">Role:</label>
                    <div class="col-xs-9 col-xs-offset-1">
                        <select id="roleVoter" class="form-control selop" name="role" onchange="showVoter(this)">
                            <option id="o1">Party</option>
                    ...
                    <input list="locationId"  name="locationId" placeholder="Location Id" class="location form-control col-xs-12">
					...
					<input list="electionId2"  name="electionId" placeholder="Election ID" class="electionId form-control col-xs-12">
                    <datalist id="electionId2">
					 <c:forEach var="c" items="${sessionScope.elecList}">
					 	<option> ${c.id}</option>
					 	</c:forEach>
					</datalist>

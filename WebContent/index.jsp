...
<body>
	<div class="container col-xs-12 text-center">
            ...
            <div class="col-sm-8 col-sm-offset-2">
                <a href="admin/createElection" class="btn btn-primary col-xs-12">Setup Election</a>
                <div class="col-xs-12">&nbsp;</div>
                <a href="admin/register" class="btn btn-primary col-xs-12">Register</a>
                <div class="col-xs-12">&nbsp;</div>
                <a href="admin/login" class="btn btn-primary col-xs-12">Login</a>
            </div>
            </div>
        </div>
</body>
